...
def Main():
	...
	### Your code here, one line ###
	face_detection_model = Model(acl_resource, MODEL_PATH)
	...
	# one line of code to create an object of the 'Model' class with two parameters: the created 'AclResource' object and the 'MODEL_PATH'
	### Your code here, one line ###
	head_pose_model = Model(acl_resource, MODEL_PATH)
	...
	### Your code here, one line ###
	resultList_face = face_detection_model.execute([input_image])
	...
	### Your code here, one line ###
	resultList_head = head_pose_model.execute([input_image])
